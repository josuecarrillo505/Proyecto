#ifndef PROYECTOPOOII2019_2_CAMINOSPREDETERMINADOS_H
#define PROYECTOPOOII2019_2_CAMINOSPREDETERMINADOS_H
#include <iostream>
#include <vector>
using namespace std;
...
#endif //PROYECTOPOOII2019_2_CAMINOSPREDETERMINADOS_H
